        ...
        return args -> {
            if (userRepository.count() == 0) {
                ...
                User alice = new User("Alice", "alice@test.com",
                        passwordEncoder.encode("alice1234!"), Role.USER);
                User bob = new User("Bob", "bob@test.com",
                        passwordEncoder.encode("bob1234!"), Role.USER);

                userRepository.save(alice);
                userRepository.save(bob);

                // 각자 계좌 생성
                Account a1 = new Account("100-1111-1111", 1_000_000L, alice);
                Account a2 = new Account("200-2222-2222", 50_000L, bob);
